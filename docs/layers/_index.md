...
| [cscope](cscope/)                                     | cscope layer provides a smart [cscope](https://cscope.sourceforge.net/) and [pycscope](https://github.com/portante/pycscope) helper for spacevim, help users win at cscope. |
...
| [floobits](floobits/)                                 | This layer adds support for the peer programming tool [floobits](https://github.com/floobits) to spacevim.                                                                                         |
